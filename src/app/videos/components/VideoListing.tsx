...
const VideoListing: React.FC<VideoListingProps> = ({ id, title }) => (
  <li className="after:border-white/dim mx-6 flex flex-col items-center gap-3 pt-10 not-last:after:mt-7 not-last:after:w-96 not-last:after:max-w-full not-last:after:border-b">
